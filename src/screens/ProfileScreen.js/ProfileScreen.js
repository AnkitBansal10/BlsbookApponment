      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.card}>
          ...
          <View style={styles.menuContainer}>
            <MenuItem icon={<Heart size={20} />} text="Favourites" />
            <MenuItem icon={<Download size={20} />} text="Downloads" />
            <View style={styles.divider} />
            <MenuItem icon={<Globe size={20} />} text="Languages" />
            <MenuItem icon={<MapPin size={20} />} text="Location" />
            <MenuItem icon={<PlayCircle size={20} />} text="Subscription" />
            <MenuItem icon={<Monitor size={20} />} text="Display" />
            <View style={styles.divider} />
            <MenuItem icon={<Trash2 size={20} />} text="Clear Cache" />
            <MenuItem icon={<History size={20} />} text="Clear History" />
            <MenuItem icon={<LogOut size={20} />} text="Log Out" />
          </View>
